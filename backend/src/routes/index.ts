...
router.get('/products/export/xlsx', authenticate, priceTables.exportProducts)
...
router.get('/clients/check-duplicate', authenticate, clients.checkDuplicateClient)
...
router.patch('/orders/:id/faturamento', authenticate, requireAdmin, orders.updateFaturamento)
router.patch('/orders/:id/sem-comissao', authenticate, requireAdmin, orders.updateSemComissao)
...
router.post('/orders/:id/fix-pack-totals', authenticate, requireAdmin, orders.fixPackTotals)
