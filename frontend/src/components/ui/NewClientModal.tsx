...
function ConfirmTag() {
  return (
    <span className="inline-flex items-center gap-1 text-[11px] font-medium bg-amber-50 text-amber-700 border border-amber-200 rounded-full px-2 py-0.5 ml-1">
      ...
      <div className="space-y-1.5">
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div>
              <label className="block text-[11px] font-medium text-on-surface-variant mb-1">Nome Fantasia</label>
              <input
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-[11px] font-medium text-on-surface-variant mb-1">CNPJ</label>
                <input
                  value={form.cnpj}
              ...
              <div>
                <label className="block text-[11px] font-medium text-on-surface-variant mb-1">Insc. Estadual</label>
                <input
        ...
        <div className="space-y-1.5">
          ...
          {/* Telefone */}
          <div>
            <label className="block text-[11px] font-medium text-on-surface-variant mb-1 flex items-center">
        ...
        <div className="space-y-1.5">
          ...
          <div>
            <label className="block text-[11px] font-medium text-on-surface-variant mb-1">Logradouro</label>
            <input
              value={form.address}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-[11px] font-medium text-on-surface-variant mb-1">Cidade</label>
              <input
                value={form.city}
            ...
            <div>
              <label className="block text-[11px] font-medium text-on-surface-variant mb-1">UF</label>
              <input
                value={form.state}
          ...
          <div>
            <label className="block text-[11px] font-medium text-on-surface-variant mb-1">CEP</label>
            <input
              value={form.zip}
