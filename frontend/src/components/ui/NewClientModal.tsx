...
function ConfirmTag() {
  return (
    <span className="inline-flex items-center gap-1 text-[13px] font-medium bg-amber-50 text-amber-700 border border-amber-200 rounded-full px-2 py-0.5 ml-1">
  ...
  return (
    <Modal open={open} onClose={handleClose} title="Novo Cliente" size="lg">
      <div className="space-y-1.5">
        ...
        <div className="bg-primary/5 border border-blue-100 rounded-xl p-4 space-y-1.5">
          ...
          <div className="flex gap-2">
            <input
              ...
              maxLength={18}
              className="flex-1 px-3 py-1 text-[13px] border border-blue-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder:text-outline/70"
            />
            <button
              type="button"
              onClick={lookupCnpj}
              disabled={loadingCnpj}
              className="flex items-center gap-1.5 px-4 py-1 bg-primary text-white text-[13px] font-semibold rounded-lg hover:bg-primary disabled:opacity-60 transition-colors"
            >
              {loadingCnpj
        ...
        {/* ── Dados da empresa ── */}
        <div className="space-y-1.5">
          <p className="text-[13px] font-semibold text-outline uppercase tracking-wide flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-1 text-[13px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 ${errors.name ? 'border-red-400' : 'border-outline-variant'}`}
              />
              {errors.name && <p className="text-[13px] text-red-500 mt-0.5">{errors.name}</p>}
            </div>
            <div>
              <label className="block text-[13px] font-medium text-on-surface-variant mb-1">Nome Fantasia</label>
              <input
                value={form.trade_name}
                onChange={e => set('trade_name', e.target.value)}
                className="w-full px-3 py-1 text-[13px] border border-outline-variant rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
              />
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-[13px] font-medium text-on-surface-variant mb-1">CNPJ</label>
                <input
                  value={form.cnpj}
              ...
              <div>
                <label className="block text-[13px] font-medium text-on-surface-variant mb-1">Insc. Estadual</label>
                <input
        ...
        <div className="space-y-1.5">
          ...
          {/* Telefone */}
          <div>
            <label className="block text-[13px] font-medium text-on-surface-variant mb-1 flex items-center">
            ...
            <input
              ...
              className={`w-full px-3 py-1 text-[13px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 ${needsConfirm.has('phone') ? 'border-amber-300 bg-amber-50' : 'border-outline-variant'}`}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="(00) 00000-0000"
              className={`w-full px-3 py-1 text-[13px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 ${needsConfirm.has('whatsapp') ? 'border-amber-300 bg-amber-50' : 'border-outline-variant'}`}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-1 text-[13px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 ${needsConfirm.has('email') ? 'border-amber-300 bg-amber-50' : 'border-outline-variant'}`}
            />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div>
            <label className="block text-[13px] font-medium text-on-surface-variant mb-1">Logradouro</label>
            <input
              value={form.address}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-[13px] font-medium text-on-surface-variant mb-1">Cidade</label>
              <input
                value={form.city}
            ...
            <div>
              <label className="block text-[13px] font-medium text-on-surface-variant mb-1">UF</label>
              <input
                value={form.state}
          ...
          <div>
            <label className="block text-[13px] font-medium text-on-surface-variant mb-1">CEP</label>
            <input
              value={form.zip}
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            className="w-full px-3 py-1 text-[13px] border border-outline-variant rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none"
          />
        </div>

        {/* ── Ações ── */}
        {createMut.isError && (
          <p className="text-[13px] text-red-600 bg-red-50 border border-red-200 rounded-lg px-3 py-1">
