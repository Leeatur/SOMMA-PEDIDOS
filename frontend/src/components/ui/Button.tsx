...
export function Button({
  ...
  const variants = {
    primary:
      'bg-blue-700 text-white hover:bg-blue-800 focus:ring-blue-500 active:scale-95',
    secondary:
    ...
    outline:
      'border border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-gray-400 active:scale-95 bg-white',
  }
