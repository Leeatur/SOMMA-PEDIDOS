      ...
      <div className="bg-white border-b border-outline-variant px-5 py-2.5 lg:px-8">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-[12px] text-outline mt-0.5">{list.length} cadastradas</p>
          </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {f.contact && (
                        <p className="text-[12px] text-outline mt-0.5">{f.contact}</p>
                      )}
                      {f.notes && (
                        <p className="text-[12px] text-outline/70 mt-0.5 line-clamp-1">{f.notes}</p>
                      )}
                    </div>
                  </div>
                  <button
