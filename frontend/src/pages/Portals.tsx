              ...
              <div key={portal.id} className={`bg-white rounded-2xl border shadow-sm p-4 transition-all ${portal.active ? 'border-outline-variant/40' : 'border-outline-variant/20 opacity-60'}`}>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white text-[12px] font-semibold transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-[12px] font-semibold transition-colors"
                  >
