...
function CompanySection() {
  ...
  if (isLoading) return (
    <div className="h-20 flex items-center justify-center text-outline/70 text-[13px]">
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="text-[13px] font-medium text-on-surface-variant">Logo da empresa</p>
          <p className="text-[13px] text-outline/70 mb-2">PNG ou JPG · aparece no cabeçalho dos pedidos</p>
      ...
      <div className="flex items-center gap-3 pt-1">
        ...
        {saveMut.isError && (
          <p className="text-[13px] text-red-600">Erro ao salvar. Tente novamente.</p>
        )}
      </div>
    </div>
  )
    ...
    <div className="pb-24 lg:pb-0">
      ...
      <div className="bg-white border-b border-outline-variant px-5 py-2.5 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-[13px] text-outline mt-0.5">Ajustes do aplicativo</p>
        </div>
      </div>
      ...
      <div className="px-4 py-3 lg:px-8 max-w-2xl mx-auto space-y-1.5">
        ...
        {user?.role === 'admin' && (
          <div>
            <h2 className="text-[13px] font-semibold text-outline uppercase tracking-wider mb-3 flex items-center gap-1.5">
        ...
        {/* Profile */}
        <div>
          <h2 className="text-[13px] font-semibold text-outline uppercase tracking-wider mb-3">Conta</h2>
          <Card padding="md">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[13px] text-outline">{user?.email}</p>
        ...
        {/* Connectivity */}
        <div>
          <h2 className="text-[13px] font-semibold text-outline uppercase tracking-wider mb-3">Conectividade</h2>
          <Card padding="md">
            ...
            {pendingCount > 0 && (
              <div className="mt-3 pt-3 border-t border-outline-variant/50">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[13px] font-medium text-orange-600">{pendingCount} pedido{pendingCount > 1 ? 's' : ''} pendente{pendingCount > 1 ? 's' : ''}</p>
                    <p className="text-[13px] text-outline">Aguardando sincronização</p>
                  </div>
                  {online && (
        ...
        {/* Offline cache */}
        <div>
          <h2 className="text-[13px] font-semibold text-outline uppercase tracking-wider mb-3">Cache Offline</h2>
          <Card padding="md">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-[13px] text-outline">Usados quando sem conexão</p>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-surface-container-low rounded-xl p-3 text-center">
                <p className="text-[13px] font-bold text-on-surface">{cachedProductsCount}</p>
                <p className="text-[13px] text-outline">Produtos</p>
              </div>
              <div className="bg-surface-container-low rounded-xl p-3 text-center">
                <p className="text-[13px] font-bold text-on-surface">{cachedClientsCount}</p>
                <p className="text-[13px] text-outline">Clientes</p>
              </div>
            </div>
        ...
        {/* App info */}
        <div>
          <h2 className="text-[13px] font-semibold text-outline uppercase tracking-wider mb-3">Sobre</h2>
          <Card padding="md">
            <div className="space-y-1.5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-outline">Versão 1.0.0</p>
                </div>
              </div>
              <div className="pt-3 border-t border-outline-variant/50 text-[13px] text-outline">
                <p>Sistema de Gestão de Pedidos</p>
                <p className="text-[13px] mt-1">Somma Gestão Comercial &copy; {new Date().getFullYear()}</p>
              </div>
            </div>
          </Card>
        </div>
