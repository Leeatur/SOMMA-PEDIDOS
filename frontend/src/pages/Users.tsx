      ...
      <div className="bg-white border-b border-outline-variant px-5 py-2.5 lg:px-8">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-[12px] text-outline mt-0.5">{list.length} usuários</p>
          </div>
                ...
                <Card key={u.id} padding="md">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[12px] text-outline">{u.email}</p>
                      ...
                      <p className="text-[12px] text-outline/70">Criado em {formatDate(u.created_at)}</p>
                    </div>
                    <div className="flex items-center gap-1 flex-shrink-0">
                      {confirmDeleteId === u.id ? (
                        <div className="flex items-center gap-1">
                          <span className="text-[12px] text-red-600 font-medium">Confirmar?</span>
                          <button
                            onClick={() => deleteMut.mutate(u.id)}
                            disabled={deleteMut.isPending}
                            className="px-2 py-1 text-[12px] bg-red-500 text-white rounded-lg hover:bg-red-600 disabled:opacity-50 transition-colors"
                          >
                            Sim
                          </button>
                          <button
                            onClick={() => setConfirmDeleteId(null)}
                            className="px-2 py-1 text-[12px] border border-outline-variant text-outline rounded-lg hover:bg-surface-container transition-colors"
                          >
                            Não
                          </button>
                        </div>
